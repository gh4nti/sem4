...
-- Department
INSERT INTO Department VALUES (10, 'HR', 'Bangalore');
INSERT INTO Department VALUES (20, 'IT', 'Hyderabad');
INSERT INTO Department VALUES (30, 'Finance', 'Mumbai');

-- Employee
INSERT INTO Employee VALUES (101, 'Rahul', 'M', 50000, 'Bangalore', 10);
INSERT INTO Employee VALUES (102, 'Anita', 'F', 60000, 'Hyderabad', 20);
INSERT INTO Employee VALUES (103, 'Kiran', 'M', 55000, 'Mumbai', 30);


-- 5. Try to insert few tuples into Employee and Department which violates some of the above constraints.
-- Primary key violation
INSERT INTO Department VALUES (10, 'Admin', 'Delhi');

-- NULL EmpName
INSERT INTO Employee VALUES (104, NULL, 'M', 40000, 'Chennai', 20);
...
INSERT INTO Employee VALUES (301, 'Rohit', 'M', 45000, 'Bangalore', 10, DATE '1998-06-15');
INSERT INTO Employee VALUES (302, 'Neha', 'F', 52000, 'Hyderabad', 20, DATE '1997-11-23');

UPDATE Employee
SET DOB = DATE '1996-03-10'
WHERE EmpNo = 101;

UPDATE Employee
SET DOB = DATE '1999-08-05'
WHERE EmpNo = 102;
